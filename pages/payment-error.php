                    ...
                    <div>
                        ...
                        <div class="pad_valide">
                            ...
                            <div class="alert alert-danger" id="alert_danger"role="alert">
                                <div class="message"><i class="fas fa-times me-2" style="color: red"></i>Votre paiement a été refusé.<br/>Merci de renouvelé votre demande.<br />Et à bientôt sur Love and heart.</div>
                            </div>

                            <?php if (!empty($_SESSION['user_id'])) { ?>
                                <div class="redirect_login">
                                    <i class="fas fa-directions"></i><a href="/payment-renewal">Retour</a>
                                </div>
                            <?php } else { ?>
                                <div class="redirect_login">
