...
<section class="py-5 pb-0" id="partage" <?php if ($_COOKIE['etapes'] == 3) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
...
<section class="py-5 pb-0" id="status_marital" <?php if ($_COOKIE['etapes'] == 4) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
            ...
            <div class="col-lg-6">
                <div class="row gx-5 row-cols-1 row-cols-md-2">
                    <div class="col mb-5 h-100">
                        ...
                        <a href="" class="link_c status_marital_choice" data-id="veuf">
                            <p class="mb-0">veuf</p>
                        </a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mb-5 h-100">
                        <div class="mb-3">
                            ...
                            <a href="" class="link_c poids_adulte" data-id="rond">
                                <p class="mb-3">rond</p>
                            </a>
...
<section class="py-5 pb-0" id="cheveux_adulte" <?php if ($_COOKIE['etapes'] == 10) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5 text-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
...
<section class="py-5 pb-0" id="origine" <?php if ($_COOKIE['etapes'] == 12) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5 text-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
            ...
            <div class="col-lg-6 pt-2 pb-2">
                <div class="row">
                    <div class="col mb-5 h-100">
                        ...
                        <a href="" class="link_c origine" data-id="métisse">
...
<section class="py-5 pb-0" id="religion" <?php if ($_COOKIE['etapes'] == 14) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5 text-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
            ...
            <div class="col-lg-6 pt-2 pb-2">
                <div class="row">
                    <div class="col mb-5 h-100">
                        <a href="" class="link_c religion" data-id="agnostique">
                        ...
                        <a href="" class="link_c religion" data-id="bouddhiste">
...
<section class="py-5 pb-0" id="cigarette" <?php if ($_COOKIE['etapes'] == 15) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5 text-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
...
<section class="py-5 pb-0" id="photo" <?php if ($_COOKIE['etapes'] == 16) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5 text-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
            ...
            <div class="col-lg-6 pt-2 pb-2">
                <div class="row">
                    <div class="col mb-2 h-100" style="padding-right: 0;padding-left: 0;">
...
<section class="py-5 pb-0" id="ideal" <?php if ($_COOKIE['etapes'] == 17) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
...
<section class="py-5 pb-0" id="ideal_status_marital" <?php if ($_COOKIE['etapes'] == 18) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
            ...
            <div class="col-lg-6 pt-2 pb-2">
                <div class="row ideal">
                    <div class="col mb-5 h-100">
                        ...
                        <a href="" class="link_c ideal_status_marital" data-id="veuve">
                            <p class="mb-3 mt-3">veuve</p>
                        </a>
                    </div>
                </div>
            </div>
...
<section class="py-5 pb-0" id="ideal_enfant" <?php if ($_COOKIE['etapes'] == 19) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
                ...
                <p class="subtitle">Veut des enfants ?</p>
            </div>
            <div class="col-lg-6 pt-2 pb-2">
                <div class="row ideal">
                    <div class="col mb-5 h-100">
...
<section class="py-5 pb-0" id="ideal_taille" <?php if ($_COOKIE['etapes'] == 20) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
...
<section class="py-5 pb-0" id="ideal_poids" <?php if ($_COOKIE['etapes'] == 21) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
...
<section class="py-5 pb-0" id="ideal_fume" <?php if ($_COOKIE['etapes'] == 22) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
...
<section class="py-5 pb-0" id="ideal_demarquation" <?php if ($_COOKIE['etapes'] == 23) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 24) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
                ...
                <div class="suggestion_d">
                    <div class="suggestion" data-slide="1">
                        <p>Alain - 35 ans</p>
                        <p>Jeune Homme souriant et généralement en retard cherche un homme bavard, têtu et indécis.</p>
                    </div>

                    <div class="suggestion" data-slide="2" style="display: none;">
                        <p>Juliette - 22 ans</p>
                        <p>Jeune Femme souriante qui aime croquer la vie à pleines dents. Pas de prise de tête.</p>
                    </div>
                ...
                <div class="row ideal">
                    <div class="col mb-5 h-100">
                        <form method="post" class="" id="submit_ideal_demarquation">
                            ...
                            <textarea class="form-control demarq_textarea" id="ideal_demarquation_text" name="ideal_demarquation_text" placeholder="Écrivez ici"></textarea>

                            <div class="loading" style="display: none;">
                                <i class="fas fa-spinner fa-spin spiner_sub" aria-hidden="true"></i>
                            </div>

                            <div class="alert alert-success" id="alert_success" role="alert" style="display: none;">
                            ...
                            <button class="btn btn-info btn-ideal valid_ideal_demarq mt-0 mb-0">Valider</button>
                        </form>
                    </div>
                </div>
            </div>
...
<section class="py-5 pb-0" id="formule" <?php if ($_COOKIE['etapes'] == 24) { ?>style="display: block;" <?php } else if ($_COOKIE['etapes'] == 23) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 22) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 21) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 20) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 19) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 18) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 17) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 16) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 15) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 14) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 13) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 12) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 11) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 10) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 9) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 8) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 7) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 6) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 5) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 4) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 3) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 2) { ?>style="display: none;" <?php } else if ($_COOKIE['etapes'] == 1) { ?>style="display: none;" <?php } ?>>
    <div class="container px-2 my-5">
        <div class="row gx-5">
            <div class="col-lg-12 mb-5 mb-lg-0">
                <h2 class="fw-bolder mb-0">
                    <p class="title m-auto" style="max-width: 512px; float: none; font-weight: normal;">Abonnez-vous pour bénéficier de tous les avantages du Pass</p>
                </h2>
            </div>
        </div>

        <div class="col-lg-5 pt-4 pb-4 m-auto">

            <div class="icon_formule">
                <div class="left_icon_formule icon_formule_mobile">
                    <div class="left_icon_formule_before">
                        <i class="far fa-comments"></i>
                    </div>

                    <div class="left_icon_formule_before left_icon_formule_before_5">
                        <i class="far fa-grin-hearts"></i>
                    </div>

                    <div class="left_icon_formule_before left_icon_formule_before_7">
                ...
                <div class="formule">
                    <div class="formule_title">
                        <p>1 Pass = 7x plus de messages</p>
                    </div>

                    <div class="formule_bloc">
                        <div class="formule_triangle"> </div>
                        <div class="formule_triangle_bottom"> </div>

                        <div class="formule_list" style="margin-top: -30px;">
                            <div class="formule_avantage_triangle"></div>
                            <div class="formule_avantage">
                                Échangez sans limite avec qui vous voulez
                            </div>
                        </div>
                        ...
                        <div class="formule_list">
                            <div class="formule_avantage_triangle"></div>
                            <div class="formule_avantage">
                                Personnalisez vos recherches grâce aux filtres avancés
                            </div>
                        </div>
                        ...
                        <div class="formule_list" style="margin: 0.2em auto;">
                            <div class="formule_avantage">
                                <a href="payment" class="btn btn-info btn-validate-formule">Abonnez-vous</a>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="right_icon_formule icon_formule_mobile">
                    <div class="right_icon_formule_before">
                        <i class="fas fa-laptop-house"></i>
                    </div>

                    <div class="right_icon_formule_before right_icon_formule_before_5">
                        <i class="fas fa-mobile-alt"></i>
                    </div>

                    <div class="right_icon_formule_before right_icon_formule_before_7">
            ...
            <div class="suggestion_formules">
                <div class="suggestion_formule" data-slide2="1"><i class="fas fa-heart me-1" style="color: #d40707;"></i>De Maxime, paiement sécurisé rien à dire, j'adore cette formule.</div>
                <div class="suggestion_formule" data-slide2="2" style="display: none;"><i class="fas fa-heart me-1" style="color: #d40707;"></i>De Lydia, en achetant cette formule, je fais des économies.</div>
            </div>
