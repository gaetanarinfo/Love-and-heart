<?php $result = selectDB('*', 'users', 'id = "' . $_GET['id'] . '"', $db, '1'); ?>
...
<div class="col-lg-4">
    <div class="profil_box">
        ...
        <p class="birthday_city mb-1"><?= ($premium->get_user() == 0) ? 'N\'est pas abonné.' : '<i class="fas fa-crown me-2" style="color: gold;"></i>Premium' ?></p>
        <p class="ideal_demarquation mb-1"><?= $result['ideal_demarquation'] ?></p>
    </div>
